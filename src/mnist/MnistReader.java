...
public class MnistReader {
  private static final String DIR = "./mnist/";
  private static final String TRAINING_IMAGES_FILE = DIR + "train-images-idx3-ubyte";
  private static final String TRAINING_LABELS_FILE = DIR + "train-labels-idx1-ubyte";
  private static final String TEST_IMAGES_FILE = DIR + "t10k-images-idx3-ubyte";
  private static final String TEST_LABELS_FILE = DIR + "t10k-labels-idx1-ubyte";
  ...
  private static List<MnistNumber> readSet(String trainingImagesFile,
    ...
    try (MnistImagesReader imagesReader = MnistImagesReader.open(trainingImagesFile);
      ...
      if (imagesReader.imageCount != labelsReader.labelsCount) {
        throw new RuntimeException("images count (" + imagesReader.imageCount
            + ") differ from labels count (" + labelsReader.labelsCount + ").");
      }
